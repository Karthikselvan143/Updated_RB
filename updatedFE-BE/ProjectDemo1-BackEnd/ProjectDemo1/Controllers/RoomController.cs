...
namespace ProjectDemo1.Controllers
{
    ...
    public class RoomController : ControllerBase
    {
        ...
        public async Task<IActionResult> CancelBooking([FromBody] CancelBookingRequest request)
        {
            ...
            {
                return BadRequest("Invalid request. Ensure `BookingId` is provided and valid.");
            }

            var booking = await dbContext.bookings
                .Include(b => b.Room) // Ensure Room is included in the query
            ...
            {
                return StatusCode(500, $"Error updating the booking status: {ex.Message}");
            }
        }
        ...
        public class CancelBookingRequest
        {
            public int BookingId { get; set; } // Make sure this matches the frontend payload
        }
